        ...
        <div class="col-md-6 login-right-box">
            <div class="row align-items-center">
                <div class="header-text mb-4">
                    ...
                    <p>We will send you the password reset link.</p>
                </div>
                <div class="input-group mb-3">
                    <input type="email" name="userEmail" id="userEmail" class="form-control form-control-lg bg-light fs-6" placeholder="Email Address">
                </div>
                <div class="input-group mb-3">
                    <button class="btn btn-lg btn-primary w-100 fs-6">Send Reset Email</button>
                </div>
                <div class="row">
