...
class ApplicationCreateRecord
{
    public static function loadApplicationCreateRecord(string $controller, array $data): array|bool
    {
...
//            dd(Fields::FIELD[$controller]);
            ...
            // randomId will be added at ValidateApplicationForm
//            $parameters = self::addRandomId($controller, $parameters);
