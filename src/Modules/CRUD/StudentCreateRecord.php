...
class StudentCreateRecord
{
    public static function loadStudentCreateRecord(string $controller, array $data): array|bool
    {
...
//            dd(Fields::FIELD[$controller]);
            ...
            // randomId will be added at ValidateStudentForm
